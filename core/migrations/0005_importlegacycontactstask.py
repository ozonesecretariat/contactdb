# Generated by Django 4.2.11 on 2024-05-10 12:21
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("core", "0004_alter_contactgroup_options"),
    ]

    operations = [
        migrations.CreateModel(
            name="ImportLegacyContactsTask",
            fields=[
                (
                    "id",
                    models.UUIDField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Delete all contacts from the 'Legacy contacts' group before importing.",
                    ),
                ),
                (
                    "json_file",
