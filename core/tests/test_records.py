...
def test_create_record_no_perm(login_user_no_perm, contact, snd_organization):
    client, user = login_user_no_perm
    contact.organization.save()

    data = {
        "contact_id": "5959ec2af439c413049fc55e",
        "organization": str(contact.organization.pk),
        "title": "Mr.",
        "first_name": "Alex",
        "last_name": "Alexandrovici",
        "designation": "Director",
...
def test_create_record_can_edit(login_user_can_edit, first_organization):
    client, user = login_user_can_edit
    first_organization.save()

    data = {
        "contact_id": "5959ec2af439c413049fc55e",
        "organization": str(first_organization.pk),
        "title": "Mr.",
        "first_name": "Alex",
        "last_name": "Alexandrovici",
        "designation": "Director",
